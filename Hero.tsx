...
const content = {
  en: {
    ...
    paidService: "सिद्धिविनायक ज्योतिषमार्फत पुरविण्यात येणाऱ्या सर्व सेवा या सशुल्क आहेत."
  },
  mr: {
        ...
        <div className="container z-10 w-full px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 text-center md:text-left">
                <div className="flex flex-col items-center md:items-start">
                    ...
                    <p className="mt-4 text-white font-bold [text-shadow:0_1px_4px_rgba(0,0,0,0.6)]">
                      {content[lang].paidService}
                    </p>
                </div>
